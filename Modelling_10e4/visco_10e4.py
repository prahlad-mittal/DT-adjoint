...
output_file = VTKFile("output_10e4.pvd")
ref_file = VTKFile('reference_state_10e4.pvd')
output_frequency = 20

plog = ParameterLog('params_10e4.log', mesh)
...
with CheckpointFile("Final_State_10e4.h5", "w") as final_checkpoint:
