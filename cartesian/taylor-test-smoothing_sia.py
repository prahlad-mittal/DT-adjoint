...
dt_top = Function(Q1, name="force_top")
dt_top.interpolate(surface_force)
...
VTKFile("inverse-visualisation.pvd").write(*z.subfunctions, T, dt_top, der_func, residual_topography)
